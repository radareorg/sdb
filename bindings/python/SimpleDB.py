...
class Sdb(Structure): #1
	...
	array_del, sdb_array_del = register('sdb_array_del','c_void_p, c_char_p, c_int, c_uint','c_bool')
	...
	expire_set, sdb_expire_set = register('sdb_expire_set','c_void_p, c_char_p, c_ulonglong','c_bool')
